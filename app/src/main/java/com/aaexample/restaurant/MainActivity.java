...
import com.aaexample.restaurant.classes.Ingredient;
              ...
              /*  checkUser.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        if(snapshot.exists()){
                            ...
                            String pass = snapshot.child("mot_de_passe").getValue(String.class);
                            Toast.makeText(getApplicationContext(),snapshot.getKey(),Toast.LENGTH_LONG).show();
                        }
                        else{
                ...
                db.getReference().child("Users").addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        Toast.makeText(getApplicationContext(),post.toString(),Toast.LENGTH_LONG);
                    }
...
*/
                //Intent i = new Intent(getApplicationContext(),Item.class);
                //startActivity(i);
               // Toast.makeText(getApplicationContext(),"c fait",Toast.LENGTH_LONG).show();
            }
        });
    }
}